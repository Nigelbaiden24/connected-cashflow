...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "relative hidden min-h-screen w-[--sidebar-width] bg-transparent transition-[width] duration-200 ease-linear md:block",
      ...
      <div
        className={cn(
          "fixed inset-y-0 z-50 hidden min-h-screen w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
