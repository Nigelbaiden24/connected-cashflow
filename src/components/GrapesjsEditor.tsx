...
export function GrapesjsEditor({ initialHtml, onSave, height = '100vh' }: GrapesjsEditorProps) {
  ...
  useEffect(() => {
    ...
    // Table Blocks - wrapped in div for proper GrapesJS handling
    bm.add('table-basic', {
      label: '📊 Table 3x3',
      content: {
        type: 'default',
        content: `<div class="table-wrapper" data-gjs-type="default" data-gjs-droppable="false" style="margin: 20px 0;">
    ...
    bm.add('table-financial', {
      ...
      content: {
        type: 'default',
        content: `<div class="table-wrapper" data-gjs-type="default" data-gjs-droppable="false" style="margin: 20px 0; box-shadow: 0 2px 8px rgba(0,0,0,0.08); border-radius: 8px; overflow: hidden;">
          <table style="width: 100%; border-collapse: collapse;">
            <thead>
    ...
    bm.add('table-striped', {
      ...
      content: {
        type: 'default',
        content: `<div class="table-wrapper" data-gjs-type="default" data-gjs-droppable="false" style="margin: 20px 0; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden;">
          <table style="width: 100%; border-collapse: collapse;">
            <thead>
    ...
    bm.add('table-pricing', {
      ...
      content: {
        type: 'default',
        content: `<div class="pricing-wrapper" data-gjs-type="default" data-gjs-droppable="false" style="display: flex; gap: 20px; margin: 20px 0; flex-wrap: wrap;">
          <div style="flex: 1; min-width: 200px; border: 1px solid #e2e8f0; border-radius: 12px; padding: 24px; text-align: center; background: white;">
