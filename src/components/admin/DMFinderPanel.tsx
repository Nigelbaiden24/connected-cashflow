      ...
      <div className="relative overflow-hidden rounded-3xl border border-white/5 bg-[radial-gradient(ellipse_at_top_right,rgba(168,85,247,0.12),transparent_50%),radial-gradient(ellipse_at_bottom_left,rgba(34,211,238,0.10),transparent_55%),linear-gradient(135deg,#020617,#0b1120)] p-6 md:p-8">
        ...
        <div className="relative flex items-start justify-between flex-wrap gap-4">
          <div className="space-y-3">
            <div className="inline-flex items-center gap-2 rounded-full border border-violet-400/30 bg-violet-500/10 px-3 py-1 text-[11px] text-violet-200">
            ...
            {[
              ...
              <div key={f.id} className="space-y-1.5">
                ...
                <Input
                  ...
                  className="bg-slate-950/70 border-white/10 text-slate-100 focus-visible:ring-violet-500/40 focus-visible:border-violet-400/40"
                />
              </div>
            ))}
          </div>
        ...
        <Card className="bg-slate-900/40 backdrop-blur-xl border-white/5">
          <CardHeader className="flex flex-row items-center justify-between flex-wrap gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button onClick={exportCsv} variant="outline" size="sm" className="border-white/10 bg-slate-950/60 text-slate-200 hover:border-violet-400/40 hover:text-violet-200">
          ...
          <CardContent>
            <div className="rounded-2xl border border-white/5 overflow-hidden bg-slate-950/40">
              <Table>
                ...
                <TableBody>
                  {filtered.map((c) => (
                    <TableRow key={c.id} className="border-white/5 hover:bg-violet-500/[0.04] transition-colors">
                      <TableCell className="text-slate-100">
                        <div className="flex items-center gap-2.5">
                          <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-violet-500/30 to-cyan-500/30 border border-white/10 flex items-center justify-center text-xs font-bold text-violet-100 shadow-inner">
                      ...
                      <TableCell>
                        {c.relevance_tag && <Badge variant="outline" className="border-white/10 bg-slate-900/50 text-slate-300 text-[10px]">{c.relevance_tag}</Badge>}
                      </TableCell>
                      <TableCell className="text-right">
                        <Button size="sm" variant="outline" disabled={c.saved_to_crm} onClick={() => saveToCrm(c)}
                          className={`border-white/10 bg-slate-950/60 text-slate-200 ${c.saved_to_crm ? "opacity-60" : "hover:border-emerald-500/50 hover:text-emerald-300 hover:shadow-[0_4px_12px_-2px_rgba(16,185,129,0.4)]"}`}>
