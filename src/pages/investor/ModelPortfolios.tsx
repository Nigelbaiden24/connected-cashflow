...
const ModelPortfolios = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/20 to-background">
      <div className="p-6 space-y-8 investor-theme max-w-7xl mx-auto">
        {/* Hero Header */}
          ...
          <TabsContent value="my" className="mt-0">
            ...
            {portfolios.filter(p => p.user_id).length === 0 && (
              <Card className="p-12 text-center border-dashed">
                ...
                <h3 className="text-xl font-semibold mb-2">No Personal Portfolios Yet</h3>
                <p className="text-muted-foreground mb-6">
                  Upload your portfolio to get AI-powered analysis and compare with professional strategies
                </p>
