...
const Chat = () => {
  ...
  return (
    <div className="flex h-full flex-col relative ai-chat-gradient dark:ai-chat-gradient-dark min-h-screen">
      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 z-20 md:left-[var(--sidebar-width)] md:right-auto md:w-[calc(100vw-var(--sidebar-width))]">
        <div className="ai-glass-card rounded-2xl p-4 shadow-2xl border border-primary/20 ai-glow-border max-w-5xl w-full">
