...
export default function Features() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden py-24 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-xl md:text-2xl text-white/95 drop-shadow-lg animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-150">
              Comprehensive platforms for financial advisors and investors, powered by cutting-edge technology and expert research
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {financeFeatures.map((feature, idx) => (
              <Card key={idx} className="hover:shadow-xl transition-all hover:-translate-y-1 duration-300 border-2 hover:border-blue-200 dark:hover:border-blue-800">
                <CardHeader>
      ...
      <section className="relative py-20 bg-gradient-to-br from-purple-50 via-indigo-50 to-blue-50 dark:from-purple-950/20 dark:via-indigo-950/20 dark:to-blue-950/20">
      ...
      <section className="relative py-20 bg-gradient-to-br from-gray-50 to-slate-100 dark:from-gray-900 dark:to-slate-900">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">Why Choose FlowPulse?</h2>
            <p className="text-xl text-muted-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="text-center border-2 hover:shadow-xl transition-all">
              <CardContent className="p-8 space-y-4">
                <div className="mx-auto p-4 bg-blue-100 dark:bg-blue-900/30 rounded-2xl w-fit">
                  <Lock className="h-8 w-8 text-blue-600" />
                </div>
                <h3 className="text-xl font-bold">Bank-Level Security</h3>
                <p className="text-muted-foreground">
                  Your data is protected with enterprise-grade encryption, SOC 2 compliance, and rigorous security protocols.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center border-2 hover:shadow-xl transition-all">
              <CardContent className="p-8 space-y-4">
                <div className="mx-auto p-4 bg-purple-100 dark:bg-purple-900/30 rounded-2xl w-fit">
                  <Sparkles className="h-8 w-8 text-purple-600" />
                </div>
                <h3 className="text-xl font-bold">AI-Powered Intelligence</h3>
                <p className="text-muted-foreground">
                  Our proprietary AI analyses millions of data points to surface insights that give you an edge.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center border-2 hover:shadow-xl transition-all">
              <CardContent className="p-8 space-y-4">
                <div className="mx-auto p-4 bg-emerald-100 dark:bg-emerald-900/30 rounded-2xl w-fit">
                  <TrendingUp className="h-8 w-8 text-emerald-600" />
                </div>
                <h3 className="text-xl font-bold">Proven Track Record</h3>
                <p className="text-muted-foreground">
                  Trusted by financial professionals and investors worldwide with a history of delivering results.
                </p>
              </CardContent>
            </Card>
          </div>
