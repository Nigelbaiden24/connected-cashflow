...
const CATEGORY_RESEARCH_SOURCES: Record<string, { queries: string[]; urls: string[] }> = {
  ...
  crowdfunding: {
    queries: [
      "equity crowdfunding opportunities live campaigns UK 2025",
      "crowdfunding investment platforms best deals open now",
      "Seedrs Crowdcube Republic live investment rounds 2025",
      "real estate crowdfunding platforms opportunities current",
      "mini bonds community shares investment opportunities UK",
      "revenue share crowdfunding deals live now investors",
      "crowdfunding startups raising capital open rounds 2025",
      "equity crowdfunding SEIS EIS tax relief investments live",
    ],
    urls: [
      "https://www.seedrs.com/invest",
      ...
      "https://www.wefunder.com/explore",
      "https://www.startengine.com/explore",
      "https://www.ethex.org.uk/invest",
      "https://www.triodos-im.com/crowdfunding",
    ],
  },
  startup_funding: {
    queries: [
      "startup funding news latest rounds raised 2025",
      "UK startup funding rounds series A B seed today",
      "European startups raising funding now venture capital 2025",
      "SEIS EIS eligible startups seeking investment UK current",
      "startup accelerator demo day companies open for investment 2025",
      "fintech healthtech proptech cleantech startup funding news",
      "pre-seed seed round startups seeking angel investment now",
      "startup funding tracker latest deals VC backed 2025",
      "Y Combinator Techstars cohort latest startups funded",
      "startup IPO pipeline companies planning public listing 2025",
    ],
    urls: [
      "https://techcrunch.com/category/venture/",
      "https://news.crunchbase.com/venture/",
      ...
      "https://www.uktech.news/",
      "https://pitchbook.com/news/reports",
      "https://www.beauhurst.com/blog/",
      "https://www.startups.co.uk/funding/",
    ],
  },
  property_opportunities: {
    queries: [
      "off plan property developments investment UK 2025",
      "auction property investment opportunities below market value",
      "distressed property assets for sale UK repossession bargains",
      "student accommodation investment opportunities UK cities 2025",
      "serviced apartments investment UK high yield opportunities",
      "co-living property investment opportunities UK Europe",
      "social housing investment opportunities guaranteed rent UK",
      "property development sites planning permission for sale",
      "commercial to residential conversion investment UK",
      "property crowdfunding platforms live deals open now",
    ],
    urls: [
      "https://www.propertyinvestortoday.co.uk/",
      "https://www.propertyauctionaction.co.uk/",
      ...
      "https://www.capitalproperty.com/",
    ],
  },
  infrastructure: {
    queries: [
      "infrastructure investment opportunities UK 2025 projects",
      "renewable energy investment solar wind farm opportunities",
      "infrastructure funds open to investors institutional grade 2025",
      "data centre investment opportunities UK Europe expansion",
      "green hydrogen energy transition investment opportunities",
      "transport rail infrastructure investment UK HS2 projects",
      "water utilities infrastructure investment opportunities",
      "5G telecoms infrastructure investment fund opportunities",
      "social infrastructure schools hospitals investment UK",
      "clean energy transition investment renewable projects fund",
    ],
    urls: [
      "https://www.infrastructure-intelligence.com/",
      "https://www.globalinfrastructurehub.org/",
      "https://www.i3-invest.com/",
      "https://renewablesnow.com/",
      "https://www.energylivenews.com/",
      "https://www.gov.uk/government/publications/national-infrastructure-delivery-plan-2024-to-2025",
